                        ...
                        <div class="col-lg-4 col-xs-12 col-sm-5 col-md-4 avt">
                            ...
                            <div class="avatar pull-left dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li role="presentation"><a role="menuitem" tabindex="-2" href="chatsof/logout.php">חזרה לדף הבית</a></li>
...
<div id="scroll"></div>
                                                ...
                                                <a href="Delete_update_user.php"> <button class="btn btn-pur">מחיקה/חסימה של משתמשים</button> </a>
                                                    </div>
                                                 
                                                <div class="networks">
                                             
                                             <a href="add_delete_courses.php"> <button class="btn btn-blu" >הוספה/הסרה של קורסים</button> </a>
                                                 </div>
                                              
                                                <div class="networks">
                                             
                                                  <a href="CheckAddAdmin.php"> <button class="btn btn-tw" >הוספה של מנהל</button>   </a>                                                    
                                                    </div>
                                                    <div class="networks">
                                             
                                                <a href="index2Admin.php"> <button class="btn btn-fb">פורום</button> </a>
                                                    </div>
