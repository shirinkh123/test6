                        ...
                        <div class="col-lg-4 col-xs-12 col-sm-5 col-md-4 avt">
                            ...
                            <div class="avatar pull-left dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="updatestudent.php">עדכון פרטים</a></li>
...
<!-- קישור לסקריפט בתחילת הדף -->
		<div id="scroll"></div>
                                             ...
                                             <a href="searchteach.php">      <button class="btn btn-fb">חיפוש מורה</button>   </a>                                                    
                                               </div>
