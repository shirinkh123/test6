                    ...
                    <div class="col-lg-4 col-xs-12 col-sm-5 col-md-4 avt">
                        ...
                        <div class="avatar pull-left dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li role="presentation"><a role="menuitem" tabindex="-3" href="chatsof/logout.php">חזרה
                                        לדף
                                        הבית</a></li>
                                        ...
                                        <div class="posttext pull-left" dir="rtl">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6" dir="rtl">
                                                    <input class="pull-right" dir="rtl" type="text" name="lnames" id="lnames"
                                                        placeholder="שם משפחה" class="form-control"
                                                        value="<?php echo $row['lastnames'];?>" />
                                                </div>
                                                <div class="col-lg-6 col-md-6">
                                                    <input  class="pull-right"  dir="rtl" type="text" id="fnames" name="fnames"
                                                        placeholder="שם פרטי" class="form-control"
                                                        value="<?php echo $row['firstnames'];?>" />
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6">
                                                    <input  class="pull-right"  dir="rtl" type="password" placeholder="סיסמא חדשה"
                                                        class="form-control" id="passs2" name="passs2" />
                                                </div>
                                                <div class="col-lg-6 col-md-6">
                                                    <input  class="pull-right"  dir="rtl" type="text" placeholder="סיסמא נוכחית"
                                                        class="form-control" id="passss" name="passss"
                                                      />
                                                </div>
  ...
  <div class="clearfix">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-10 col-md-10">
                                                    ...
                                                    <select  class="pull-right"  dir="rtl" class="form-control" name="cf-Citiesupdates[]"
                                                        id="cf-Citiesupdates" multiple>
                                     ...
                                     ?>
                                       <div class="clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10">
                                                    ...
                                                    <select  class="pull-right"  dir="rtl" class="form-control" name="cf-korsupdates[]"
                                                        id="cf-korsupdates" multiple>
                                              ...
                                              ?>
                                                ...
                                                <div class="col-lg-10 col-md-10">
                                                   <div  class="pull-right" > <?php echo ":השכלה";?></div>
                                                    ...
                                                    <select   class="pull-right"  dir="rtl" class="form-control" name="cf-budgets"
                                                        id="cf-budgets" placeholder="השכלה">
                                ...
                                <div class="postinfobot">
                                    ...
                                    <div class="pull-right postreply">
                                        <div class="pull-left"><button type="button" class="btn btn-primary"
                                                name="updates" id="updates">עדכן</button></div>
